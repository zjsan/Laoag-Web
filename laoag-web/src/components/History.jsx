    ...
    <section id="history-section">
      ...
      <h2>A Glimpse into History</h2>
        <div className="history-landmark-container">
            <img className="history-pictures" id="cathedral" src="/images/church2.webp" alt="St. William Cathedral"/>
            <img className="history-pictures" id="belltower" src="/images/Laoag_Sinking_Bell_Tower_(A._Bonifacio,_Laoag,_Ilocos_Norte;_11-16-2022).jpg" alt="Laoag City Bell Tower"/>
        </div>
